...
import { Ship, Waves, BookOpen, Users, Shield, Anchor, Globe, TrendingUp, CheckCircle, ArrowRight, FileText, Award } from 'lucide-react';
...
const Services = () => {
  ...
  const categories = [
    ...
    { id: 'economy', name: 'Blue Economy', icon: <Waves className="w-5 h-5" /> },
    { id: 'research', name: 'Research', icon: <BookOpen className="w-5 h-5" /> },
    { id: 'training', name: 'Training', icon: <Users className="w-5 h-5" /> }
  ];
  ...
  return (
    <div className="w-full pt-20">
      ...
      {/* Category Filter */}
      <section className="sticky top-20 z-30 bg-white/95 backdrop-blur-lg shadow-md py-6">
            ...
            {filteredServices.map((service, idx) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* CTA */}
                  <button className="w-full bg-blue-900 text-white py-3 rounded-lg font-semibold hover:bg-blue-800 transition-all flex items-center justify-center space-x-2 group-hover:bg-yellow-500 group-hover:text-gray-900">
      ...
      <section className="py-20 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              { icon: <Award className="w-12 h-12" />, number: '50+', label: 'Projects Delivered' },
              { icon: <Users className="w-12 h-12" />, number: '500+', label: 'Professionals Trained' },
              { icon: <Globe className="w-12 h-12" />, number: '25', label: 'Countries Served' },
              { icon: <TrendingUp className="w-12 h-12" />, number: '98%', label: 'Client Satisfaction' }
            ].map((stat, idx) => (
